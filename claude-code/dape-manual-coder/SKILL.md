...
- Do not use `Monitor`, background watches, scheduled wakeups or polling loops
  for the review. The round ends when the summary block is delivered; the
  owner brings the reply. Never claim a watch is running in this mode.
